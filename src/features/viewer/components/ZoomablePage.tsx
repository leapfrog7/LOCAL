...
import type { AnnotationPoint, DocumentPage, OCRBoundingBox, OCRWord } from '../../../domain/types'
...
export function ZoomablePage({ src, alt, rotation, highlights = [], annotations = [], annotationsVisible = true, annotationMode = 'pan', annotationColor = '#d32f2f', annotationWidth = .006, selectedAnnotationId, ocrWords = [], snapHighlights = true, initialView, trimMargins = false, onAnnotationSelect, onAnnotationEditStart, onAnnotationTextRequest, onAnnotationsChange, onViewChange, onNavigate }: { src: string; alt: string; rotation: number; highlights?: OCRBoundingBox[]; annotations?: AnnotationStroke[]; annotationsVisible?: boolean; annotationMode?: AnnotationMode; annotationColor?: string; annotationWidth?: number; selectedAnnotationId?: string; ocrWords?: OCRWord[]; snapHighlights?: boolean; initialView?: PageViewState; trimMargins?: boolean; onAnnotationSelect?: (id?: string) => void; onAnnotationEditStart?: () => void; onAnnotationTextRequest?: (point: AnnotationPoint) => void; onAnnotationsChange?: (strokes: AnnotationStroke[]) => void; onViewChange?: (view: PageViewState) => void; onNavigate?: (direction: -1 | 1) => void }) {
